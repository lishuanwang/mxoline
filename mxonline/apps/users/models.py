...
class UserProfile(AbstractUser):
    ...
    image = models.ImageField(upload_to="images/%Y/%m", default=u"image/default.png", max_length=100)
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(max_length=30, verbose_name=u"验证码类型",\
                                 choices=(('register', u'注册'), ('forget', u'忘记密码'), ('update_email', u'更换邮箱')))
